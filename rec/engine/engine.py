...
from rec.utils.stats import TrainingStats
from rec.utils.save_load import save_model
from rec.utils.utility import print_dict, AverageMeter
from rec.utils.logging import get_logger
from rec.utils.loggers import VDLLogger, WandbLogger, Loggers
from rec.utils import profiler
from rec.data import build_dataloader
import pdb
...
def preprocess(is_train=False):
    ...
    assert alg in [
        ...
        'SVTR', 'LSTR', 'SVTR_LCNet', 'ViTSTR', 'ABINet', 'DB++', 'TableMaster', 'SPIN',
