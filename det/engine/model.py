...
class Model:
    ...
    Methods:
        ...
        predict(source=None, stream=False, **kwargs) -> List[engine.results.Results]:
            Performs prediction using the YOLO model.

    Returns:
        list(engine.results.Results): The prediction results.
    """
    ...
    def tune(self, use_ray=False, iterations=10, *args, **kwargs):
        """
        Runs hyperparameter tuning, optionally using Ray Tune.
